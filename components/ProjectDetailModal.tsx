  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md animate-in fade-in duration-200">
        ...
        <div className="relative w-full max-w-3xl rounded-xl border border-obsidian-border bg-obsidian-canvas shadow-2xl overflow-hidden z-10 max-h-[90vh] flex flex-col">
          {/* Modal Header */}
      ...
      {/* Standalone Full-Screen Lightbox Portal (Immune to parent transforms/filters) */}
      {mounted &&
        lightboxIndex !== null &&
        allImages[lightboxIndex] &&
        createPortal(
          <div
            className="fixed inset-0 z-[9999] flex flex-col justify-between bg-black/95 backdrop-blur-md p-4 sm:p-6 animate-in fade-in select-none"
          ...
          >
            ...
            >
              ...
              <img
                ...
                className="max-h-[72vh] max-w-[86vw] object-contain rounded-lg border border-obsidian-border shadow-2xl transition-all select-none"
                onClick={(e) => e.stopPropagation()}
                onContextMenu={(e) => e.preventDefault()}
                draggable={false}
              />
